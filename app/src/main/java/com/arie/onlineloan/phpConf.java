...
public class phpConf {
    private final static String ip = "192.168.0.117";
    ...
    public final static String URL_GET_CAR_BRAND = "https://"+ ip +"/onlineloan/get_car_brand.php";
    public final static String URL_GET_CAR_MODEL = "https://"+ ip +"/onlineloan/get_car_model.php";
    public final static String URL_GET_DETAIL_TRANSACTION = "https://"+ ip +"/onlineloan/get_detail_transaction.php";
    public final static String URL_GET_MOTOR_BRAND = "https://"+ ip +"/onlineloan/get_motor_brand.php";
