...
public class phpConf {
    ...
    public final static String URL_GET_VEHICLE_YEAR = "https://"+ ip +"/onlineloan/get_year.php";
    ...
    public final static String URL_CHANGE_STATUS = "https://"+ ip +"/onlineloan/change_status_trx.php";
